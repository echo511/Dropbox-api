 ...
 */
class PanelRenderer extends \Nette\Object implements \Nette\Diagnostics\IBarPanel
{
    ...
    public function addRequest($action, $args, $response)
    {
        ...
        $this->requests[$key]['args'] = \Nette\Diagnostics\Debugger::dump($args, true);
        $this->requests[$key]['response'] = \Nette\Diagnostics\Debugger::dump($response, true);
    }
